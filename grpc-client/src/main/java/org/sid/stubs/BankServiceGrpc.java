...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest,
      org.sid.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = org.sid.stubs.Bank.ConvertCurrencyRequest.class,
      responseType = org.sid.stubs.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest,
      org.sid.stubs.Bank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest, org.sid.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<org.sid.stubs.Bank.ConvertCurrencyRequest, org.sid.stubs.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.sid.stubs.Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.sid.stubs.Bank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest,
      org.sid.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest,
      org.sid.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest, org.sid.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest,
      org.sid.stubs.Bank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest,
      org.sid.stubs.Bank.ConvertCurrencyResponse> getGetStreamMethod() {
    io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest, org.sid.stubs.Bank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest,
      org.sid.stubs.Bank.ConvertCurrencyResponse> getFullStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest,
      org.sid.stubs.Bank.ConvertCurrencyResponse> getFullStreamMethod() {
    io.grpc.MethodDescriptor<org.sid.stubs.Bank.ConvertCurrencyRequest, org.sid.stubs.Bank.ConvertCurrencyResponse> getFullStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(org.sid.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<org.sid.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<org.sid.stubs.Bank.ConvertCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<org.sid.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getStream(org.sid.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<org.sid.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<org.sid.stubs.Bank.ConvertCurrencyRequest> fullStream(
        io.grpc.stub.StreamObserver<org.sid.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                org.sid.stubs.Bank.ConvertCurrencyResponse>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
     ...
     * </pre>
     */
    public org.sid.stubs.Bank.ConvertCurrencyResponse convert(org.sid.stubs.Bank.ConvertCurrencyRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<org.sid.stubs.Bank.ConvertCurrencyResponse> getStream(
        org.sid.stubs.Bank.ConvertCurrencyRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractStub<BankServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<org.sid.stubs.Bank.ConvertCurrencyResponse> convert(
        org.sid.stubs.Bank.ConvertCurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((org.sid.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<org.sid.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_STREAM:
          serviceImpl.getStream((org.sid.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<org.sid.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.sid.stubs.Bank.getDescriptor();
    }
